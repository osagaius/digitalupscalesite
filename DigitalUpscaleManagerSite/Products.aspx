...
<asp:Content ID="formContent" ContentPlaceHolderID="formPlaceHolder" runat="server">
    ...
    <asp:Panel ID="pnlAddProduct" runat="server">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="txtName" runat="server" Text='<%# Bind("Name") %>' Style="margin-left: 0px"></asp:TextBox>
        ...
        &nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="txtID" runat="server" Text='<%# Bind("Name") %>'></asp:TextBox>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="txtVersion" runat="server" Text='<%# Bind("Name") %>'></asp:TextBox>
        ...
        &nbsp;
        <asp:TextBox ID="txtDate" runat="server" Text='<%# Bind("Name") %>'></asp:TextBox>
        ...
        <br />
        <asp:Button ID="btnAddProduct" runat="server" Text="Add Product" OnClick="btnAddProduct_Click" ValidateRequestMode="Enabled" />
    </asp:Panel>
