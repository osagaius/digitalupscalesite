...
<asp:Content ID="formContent" ContentPlaceHolderID="formPlaceHolder" runat="server">
    ...
    <asp:Label CssClass="upscaleHeadingLabel" ID="lblContactList" runat="server" Text="Your contact list:"></asp:Label>
    <br />
    <asp:ListBox ID="lstCustomers" runat="server" Style="margin-right: 120px" Width="432px" Height="117px"></asp:ListBox>
    <div id="buttons">
        <asp:Button ID="btnSelectAdditional" runat="server" Text="Select Additional Customers" CssClass="upscaleButton" OnClick="btnSelectAdditional_Click" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
